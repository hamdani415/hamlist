    ...
    return (
        <div>
            ...
            <div className='px-1'>
                ...
                {data?.map((item) => {
                    return (
                        <div key={item.id} className='border-b-2 border-blue-400 text-sm md:text-lg sm:text-lg bg-blue-300 rounded-2xl mb-2 '>
                            <div className='flex justify-between items-center p-3'>
                                ...
                                <div className='flex gap-2 '>
                                    <p className='font-bold text-lg text-white'>{rupiah.format(item.harga)}</p>
